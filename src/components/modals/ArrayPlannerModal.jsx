...
const DEFAULT_PLANNER = {
    ...
    options: { orientation: 'both' }, // 'portrait'|'landscape'|'both'
    lastResult: null,
};
...
export default function ArrayPlannerModal({
    ...
    useEffect(() => {
        ...
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [open, trueX_m, trueY_m, planner.roofPolygonAuto, planner.roofPolygon]);
    ...
    useEffect(() => {
        ...
        const sigObj = {
            ...
            panelsCount: Array.isArray(panelsData) ? panelsData.length : 0,
        };
        ...
        const res = computePlannerLayouts({
            ...
            panelsData,
            options: {
                orientation: planner.options?.orientation || 'both',
                topN: 25,
        ...
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [open, panelsData, roofPolygon, exclusions, planner.spacing, planner.options]);
    ...
    useEffect(() => {
        ...
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [open, toolMode, selectedExclusionId, exclusions]);
        ...
        >
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                    <div className="flex flex-wrap items-end gap-3">
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                className="p-2 border border-slate-300 rounded focus:ring-2 focus:ring-emerald-500 outline-none text-sm disabled:opacity-50 disabled:bg-slate-100"
                            ...
                            <>
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        step="0.1"
                                        className="w-28 p-2 border border-slate-300 rounded focus:ring-2 focus:ring-emerald-500 outline-none text-sm disabled:opacity-50 disabled:bg-slate-100"
                                        value={roofInput.x_m}
                            ...
                            <>
                                ...
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        step="1"
                                        className="w-24 p-2 border border-slate-300 rounded focus:ring-2 focus:ring-emerald-500 outline-none text-sm disabled:opacity-50 disabled:bg-slate-100"
                        ...
                        <div>
                            ...
                            <input
                                type="number"
                                step="10"
                                className="w-32 p-2 border border-slate-300 rounded focus:ring-2 focus:ring-emerald-500 outline-none text-sm"
                        ...
                        <div>
                            ...
                            <input
                                type="number"
                                step="1"
                                className="w-28 p-2 border border-slate-300 rounded focus:ring-2 focus:ring-emerald-500 outline-none text-sm"
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        <button
                            ...
                            className="px-3 py-2 bg-slate-100 border border-slate-300 text-slate-700 rounded hover:bg-slate-200 transition-colors text-sm"
                        >
                            Reset roof polygon
                        </button>
                        <button
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 min-h-[60vh]">
                    <div className="lg:col-span-3 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                        <div className="px-4 py-3 border-b border-slate-100 bg-slate-50 flex items-center justify-between">
                            <div>
                                <div className="text-sm font-semibold text-slate-800">Roof canvas</div>
                                <div className="text-xs text-slate-500">
                                    Drag vertices to reshape the roof polygon. Drag exclusions to reposition.
                                </div>
                            </div>
                            <div className="text-xs text-slate-500">
                                Units: meters
                        ...
                        <div className="p-3">
                            <svg
                                ...
                                onClick={onSvgClick}
                                style={{ cursor: isDeleteMode ? 'not-allowed' : toolMode === 'addCorner' ? 'copy' : 'default' }}
                            >
                                <defs>
                                    <pattern
                                        id="gridMinor"
                                ...
                                {/* Edge setback band (approx): thick stroke clipped to roof */}
                                {edgeSetback_m > 0 && (
                                ...
                                {toolMode === 'delete' && hoverDeleteTarget?.type === 'exclusion' && exclusions[hoverDeleteTarget.index] && (
                                    <rect
                                ...
                                {toolMode === 'delete' && hoverDeleteTarget?.type === 'vertex' && roofPolygon[hoverDeleteTarget.index] && (
                                    <circle
                                ...
                                {roofPolygon.map((p, idx) => (
                                    <circle
                                        ...
                                        style={{ cursor: isDeleteMode ? 'not-allowed' : toolMode === 'addCorner' ? 'copy' : 'grab' }}
                                    />
                                ))}
                            ...
                            <div className="mt-2 flex justify-end items-center gap-2">
                                ...
                                <button
                                    ...
                                    title="Click an exclusion to delete it"
                                >
                                    Delete
                                </button>
                                <button
                    ...
                    <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col min-h-[60vh]">
                        <div className="px-4 py-3 border-b border-slate-100 bg-slate-50">
                            ...
                            <div className="text-xs text-slate-500">
                                Pick orientation and review ranked candidates. (Engine integration is next.)
                            </div>
                        </div>
                        ...
                        <div className="p-4 space-y-4 overflow-y-auto flex-1">
                            <div>
                                ...
                                <select
                                    ...
                                    value={planner.options?.orientation || 'both'}
                                    onChange={(e) =>
                                        updatePlanner({
                            ...
                            <div className="rounded-lg border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700">
                                <div className="font-semibold mb-1">Inputs (for engine)</div>
                                <div className="text-xs text-slate-600 space-y-0.5">
                                    <div>
                                        Roof dims (mm): {metersToMm(trueX_m)} × {metersToMm(trueY_m)}
                                    </div>
                                    <div>
                                        Panels in DB: {Array.isArray(panelsData) ? panelsData.length : 0}
                                    </div>
                                    <div>
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <div className="text-xs text-slate-400">{results.length ? `${results.length} candidates` : '—'}</div>
                                </div>
                                        ...
                                        {results.slice(0, 10).map((r, idx) => (
                                            ...
                                            >
                                                ...
                                                <div className="text-xs text-slate-500 mt-1">
                                                    {r.count ?? 0} panels · {r.rows ?? 0}×{r.cols ?? 0} · Util {Math.round((r.utilization ?? 0) * 100)}%
                                                </div>
                                            </button>
                                        ))}
                                    </div>
                        ...
                        <div className="p-4 border-t border-slate-100 bg-slate-50 flex justify-end gap-3 flex-wrap">
                            ...
                            <button
                                type="button"
                                onClick={() => onSavePlanner?.(arrayId, planner)}
            ...
            >
                ...
                <div className="mt-3 text-xs text-slate-500">
                    Tip: Use the Measure tool to gauge distances, then add an exclusion to match.
                </div>
            </Modal>
        </Modal>
    );

...
const SolarPearLogo = ({ className = "w-full h-auto" }) => (
    <svg viewBox="0 0 160 56" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="22" y="46" fontFamily="system-ui, -apple-system, sans-serif" fontWeight="900" fontSize="22" fill="#facc15" stroke="#713f12" strokeWidth="2" strokeLinejoin="round" paintOrder="stroke fill" letterSpacing="0.5">PEAR</text>
